package com.example.demo.topdf;
...
public class PdfDocument  {
    public static ByteArrayInputStream nomenclaturePDFReport (Nomenclature nomenclature) {
        ...
        try {
            ...
            Font font = FontFactory.getFont(FontFactory.COURIER, 14,
                    BaseColor.BLACK);
            Paragraph para = new Paragraph("Nomenclature list", font);
