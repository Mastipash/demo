...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests().antMatchers("/addNomenclature","/nomenclatureList").hasAnyRole( "SELLER")
                .and()
                .authorizeRequests().antMatchers("/cocOutList","/addDocOut", "/productList","/addProduct").hasAnyRole( "EMPL", "SELLER")
                .and()
